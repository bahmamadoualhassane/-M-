...
case "transfert":
  ...
  if (recipientBankBalance >= 99e999) {
...
case "pret":
  const maxLoanAmount = 10000000; //increase of decrease this
...
fs.writeFileSync(bankDataPath, JSON.stringify(bankData), "utf8");
  ...
  return message.reply(`----🌹⚜⚜🔱⚜⚜🌹----\n\n[🏦 𝗕𝗔𝗡𝗤𝗨𝗘 🏦]\n\n🕊𝗋𝖾𝗉𝖺𝗒𝖾𝗋 👻 𝖺𝗏𝖾𝖼 𝗌𝗎𝖼𝖼𝖾̀𝗌 $${amount} 𝗅𝖾 𝗉𝗋𝖾̂𝗍 𝗉𝗋𝖾̂𝗍𝖾́. 𝖨𝗅 𝗋𝖾𝗌𝗍𝖾 𝖺̀ 𝗉𝖺𝗒𝖾𝗋  💵: $${bankData[user].𝗉𝗋e𝗍} ✔•\n\n----🌹⚜⚜🔱⚜⚜🌹----`);
